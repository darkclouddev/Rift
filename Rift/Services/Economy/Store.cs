...
namespace Rift.Services.Economy
{
    public class Store
    {
        ...
        {
            new StoreItem(1u, Settings.Emote.Chest, "Сундук", StoreItemType.Chest, 600u,
                          Currency.Coins),
            new StoreItem(2u, Settings.Emote.Sphere, "Сфера", StoreItemType.Sphere, 25_000u,
                          Currency.Coins),
            new StoreItem(3u, Settings.Emote.Capsule, "Капсула", StoreItemType.Capsule, 100u,
                          Currency.Tokens),
        };
        ...
        {
            new StoreItem(6u, Settings.Emote.Chosen, "Избранные", StoreItemType.TempRole, Settings.RoleId.Chosen,
                          30_000u, Currency.Coins),
            new StoreItem(7u, Settings.Emote.DarkStar, "Темная звезда", StoreItemType.TempRole,
                          Settings.RoleId.DarkStar, 35_000u, Currency.Coins),
            new StoreItem(8u, Settings.Emote.Mythic, "Мифические", StoreItemType.TempRole, Settings.RoleId.Mythic,
                          50_000u, Currency.Coins),
        };

        static readonly List<StoreItem> StorePermanentRoles = new List<StoreItem>
        {
            new StoreItem(9u, Settings.Emote.Roles, "Токсичные", StoreItemType.PermanentRole, Settings.RoleId.Toxic,
                          40u, Currency.Tokens),
            new StoreItem(10u, Settings.Emote.Roles, "Вардилочки", StoreItemType.PermanentRole,
                          Settings.RoleId.Wardhole, 40u, Currency.Tokens),
            new StoreItem(11u, Settings.Emote.Roles, "Престижные", StoreItemType.PermanentRole,
                          Settings.RoleId.Prestige, 50u, Currency.Tokens),
            new StoreItem(12u, Settings.Emote.Roles, "K/DA", StoreItemType.PermanentRole, Settings.RoleId.KDA,
                          80u, Currency.Tokens),
        };
    }
    ...
    public class StoreItem
    {
        ...
        public StoreItem(uint id, string emote, string name, StoreItemType type, ulong roleId,
                         uint price, Currency currency)
        {
            Id = id;
            Emote = emote;
            Name = name;
