...
namespace Rift.Modules
{
    ...
    public class TestModule : RiftModuleBase
    {
        ...
        public async Task Clubs()
        {
            ...
            await Context.Channel.SendImageAsync("https://cdn.discordapp.com/attachments/406792631570661409/493939632397090846/dca0665f3e2f96d0.png");
        ...
        public async Task Update()
        {
            ...
            await Context.Channel.SendImageAsync("https://cdn.discordapp.com/attachments/387007245520732162/494276862546018327/RiftBot.png");
        ...
        public async Task Welcome()
        {
            var message = new StringBuilder()
                ...
                .AppendLine($"**4**. <#{Settings.ChannelId.Comms.ToString()}> позволит вам пообщаться с другими участниками сервера, познакомиться и получить первые награды за активность.")
            ...
            await Context.Channel.SendImageAsync("https://cdn.discordapp.com/attachments/387007083997822996/447717266826461184/5.png");
        ...
        public async Task Info()
        {
            var message = new StringBuilder()
                ...
                .AppendLine()
                .AppendLine($"Подтвердите свой игровой аккаунт в канале <#{Settings.ChannelId.Confirmation.ToString()}> и получите награду. Начните общаться в общем чате <#{Settings.ChannelId.Comms.ToString()}>, чтобы получить первую награду за активность.")
                .AppendLine()
            ...
            await Context.Channel.SendImageAsync("https://cdn.discordapp.com/attachments/394280800788545548/495241566235918347/1.png");
        ...
        public async Task Donate()
        {
            ...
            await Context.Channel.SendImageAsync("https://cdn.discordapp.com/attachments/406791810866741269/494826449455546389/bf19d089859c4608.png");

            await ReplyAsync(message1);
            await Context.Channel.SendEmbedAsync(embed1);
            await ReplyAsync(message2);

            await Context.Channel.SendImageAsync("https://cdn.discordapp.com/attachments/406791810866741269/495262171031142411/image.png");
        }
        ...
        public async Task Rank()
        {
            var sb = new StringBuilder()
                .AppendLine($"Призыватели, для регистрации вашего игрового аккаунта в нашей системе, вам нужно написать в текстовый канал <#{Settings.ChannelId.Comms.ToString()}> одну из команд ниже.")
                .AppendLine()
            ...
            await Context.Channel.SendImageAsync("https://cdn.discordapp.com/attachments/488391413860532245/493576287810617344/1.png");
            await Context.Channel.SendImageAsync("https://cdn.discordapp.com/attachments/488391413860532245/493576301123469324/2.png");
